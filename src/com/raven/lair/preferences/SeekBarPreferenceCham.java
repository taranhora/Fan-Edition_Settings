...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String RAVENLAIR = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, RAVENLAIR, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, RAVENLAIR, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(RAVENLAIR, "interval");
            if(newInterval != null)
